...
if(isset($_POST["login"]))
					{
						$sql="select * from doctors,branches where Email='{$_POST["Email"]}'and Password='{$_POST["Password"]}'";
						$res=$conn->query($sql);
                        
						if($res->num_rows>0)
						{
							$ro=$res->fetch_assoc();
                            $_SESSION["Branch_id"]=$ro["Branch_id"];
				...
				<div class="account-box">
                    <form action="" class="form-signin" method="post">
						<div class="account-logo">
                            <a href="index.php"><img src="assets/img/logo-dark.png" alt=""></a><br><br>
                            <h4>Doctor Login</h4>
                        </div>
