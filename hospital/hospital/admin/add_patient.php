                ...
                <form action="save_patient_data.php" id="add-patient-form" enctype="multipart/form-data" method="post" >
                    ...
                    <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="<?php echo $_SESSION['Branch_id']; ?>" type="text" name="Branch_Id">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Doctor Name <span class="text-danger">*</span></label>
                                <input class="form-control" value="<?php echo $_SESSION['DFirstName'];?>"type="text" name="DFirstName">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
